    ...
    "@graph": [
      {
        ...
        description:
          "Clover Retribution Wiki for codes, magic, races, traits, grimoires, weapons, bosses, quests, and beginner progression in the Roblox RPG.",
        image: {
          "@type": "ImageObject",
          url: `${siteUrl}/images/hero.webp`,
          width: 768,
          height: 432,
          caption: "Clover Retribution official key art",
        },
        potentialAction: {
          "@type": "SearchAction",
      ...
      },
      {
        ...
        name: "Clover Retribution Wiki",
        alternateName: "Clover Retribution",
        url: siteUrl,
        description:
          "Fan-made Clover Retribution guide hub focused on codes, magic, races, traits, grimoires, bosses, and update tracking.",
        logo: {
          "@type": "ImageObject",
        ...
        sameAs: [
          "https://www.roblox.com/games/10912405603/Clover-Retribution",
          "https://www.roblox.com/communities/15890651/Clover-Retribution",
          "https://discord.com/invite/clover-retribution",
          "https://trello.com/b/xKxR061L/clover-retribution-official-trello",
        ],
      },
      {
        "@type": "VideoGame",
        ...
        genre: ["Action RPG", "Anime", "Fantasy", "Roblox"],
        numberOfPlayers: {
          minValue: 1,
          maxValue: 20,
        },
        offers: {
          ...
          url: "https://www.roblox.com/games/10912405603/Clover-Retribution",
        },
      },
      {
        "@type": "VideoObject",
        name: "the ULTIMATE Clover Retribution starters guide! (updated)",
        description:
          "Starter guide and gameplay overview for Clover Retribution focused on early progression and core systems.",
        uploadDate: "2024-01-01",
        thumbnailUrl: `${siteUrl}/images/hero.webp`,
        embedUrl: "https://www.youtube.com/embed/f7Tiw0gWtQ0",
        url: "https://www.youtube.com/watch?v=f7Tiw0gWtQ0",
      },
    ],
  };
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-8 scroll-reveal">
            ...
            <div className="mb-10 flex flex-col justify-center gap-3 sm:flex-row md:mb-12 md:gap-4">
              ...
              <a
                href="https://www.roblox.com/games/10912405603/Clover-Retribution"
                target="_blank"
      ...
      <section className="px-4 py-10 md:py-12">
        <div className="scroll-reveal container mx-auto max-w-6xl">
          <div className="relative overflow-hidden rounded-2xl">
            <VideoFeature
              videoId="f7Tiw0gWtQ0"
              title="Clover Retribution Starter Guide"
            ...
            {t.modules.lucidBlocksCreaturesAndEnemies.creatures.map(
              (c: any, index: number) => (
                ...
                >
                  <div className="mb-3">
                    <span
                      className={`text-xs px-2 py-1 rounded-full border ${["Hostile Enemy", "Major Threat", "Elite Threat"].includes(c.role) ? "bg-[rgb(239_68_68_/_0.1)] border-[rgb(239_68_68_/_0.3)] text-[rgb(248_113_113)]" : "bg-[hsl(var(--nav-theme)/0.1)] border-[hsl(var(--nav-theme)/0.3)]"}`}
                    >
                      {c.role}
                    </span>
                  </div>
              ...
              (p: any, index: number) => (
                ...
                >
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span
                      className={`text-xs px-2 py-1 rounded-full border ${p.priority === "Essential" ? "bg-[rgb(239_68_68_/_0.1)] border-[rgb(239_68_68_/_0.3)] text-[rgb(248_113_113)]" : p.priority === "Very High" ? "bg-orange-500/10 border-orange-500/30 text-orange-400" : "bg-[hsl(var(--nav-theme)/0.1)] border-[hsl(var(--nav-theme)/0.3)]"}`}
                    >
                      {p.priority}
                    </span>
                  </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  <a
                    href="https://discord.com/invite/clover-retribution"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a
                    href="https://trello.com/b/xKxR061L/clover-retribution-official-trello"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[hsl(var(--nav-theme)/0.1)] border border-[hsl(var(--nav-theme)/0.3)] text-sm hover:bg-[hsl(var(--nav-theme)/0.2)] transition-colors"
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a
                    href="https://www.roblox.com/communities/15890651/Clover-Retribution"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >
